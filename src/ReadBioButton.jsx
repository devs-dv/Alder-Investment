...
const ReadBioButton = ({ onClick, text, className }) => {
  return (
    ...
    >
      <span
        className="absolute left-4 top-1/2 -translate-y-1/2 w-1.5 h-1.5 rounded-full bg-[#545454] group-hover:w-[calc(100%-32px)] group-hover:h-full group-hover:left-4 group-hover:rounded-full transition-all duration-300 ease-out"
        aria-hidden="true"
      />
