...
const peopleData = [
  ...
  },
  {
    ...
    bioK: [
      ...
      "그는 깊이 있는 전략적 통찰력과 리더십을 바탕으로 독립적인 관점에서 투자 철학을 구체화해 나가고 있습니다. 각 포트폴리오 기업의 핵심 역량을 강화하고 지속 가능한 성장을 실현하는 것을 목표로, ALDER INVESTMENTS를 진정한 진정한 가치 창출 파트너사로 자리잡게 하고 있습니다.",
