    ...
    <section className="bg-[#e7e6e2] py-16 px-5 md:px-10 lg:pr-40" id="people">
      ...
      <div className="flex flex-col lg:flex-row gap-5 lg:gap-10">
        ...
        <div className="flex-1 min-w-0">
          ...
          {language ? (
            <p className="text-[#545454] text-justify text-base font-light">
            ...
            <p
              className="text-[#545454] text-justify text-base font-light"
              style={{ wordBreak: "keep-all" }}
            >
              우리는 회사의 비전과 전략에 부합하는 최고의 전문가들로 팀을
              구성합니다. 세계적인 선도 기관과 조직에서 쌓아온 풍부한 경험을
              보유한 전문가들은 뛰어난 금융 전문성과 실행력을 통해 고객에게
              최상의 솔루션을 제공합니다.
            </p>
          )}
        </div>
