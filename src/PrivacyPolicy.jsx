          ...
          {object.language ? (
              ...
              <div className="flex-[3]">
                ...
                <p>
                  Alder Partners
                  <br />
                  East 12F, 26, Eulji-ro 5-gil, Jung-gu, Seoul, 04539, Republic
                  of Korea
                </p>
                <p>
                ...
                <p>
                  ...
                  collects, by itself or through third parties, there are: Usage
                  Data; Trackers; answers to questions; clicks; keypress events;
                ...
                <p>
                  ...
                  to contact the Owner. Any use of Cookies – or of other
                ...
                <p>
                  ...
                  organisational procedures and modes strictly related to the
                  purposes indicated. In addition to the Owner, in some cases,
                ...
                <p>
                  ...
                  may involve transferring the User's Data to a country other
                ...
                <p>
                  ...
                  Spam and bots protection, Analytics, Displaying content from
                  external platforms and Contacting the User.
                </p>
                <p>
                  <strong>Cookie Policy</strong>
                </p>
                <p>
                  This Application uses Trackers. To learn more, Users may
                  consult the{" "}
                ...
                <ul className="list-disc">
                  ...
                  <li>
                    ...
                    Users have the right to obtain the erasure of their Data
                    from the Owner.
                  </li>
                  <li>
                    <strong>
                ...
                <p>
                  ...
                  the date of the last modification listed at the bottom. Should
              ...
              <div className="flex-[3] ">
                <p>
                  ...
                  요청합니다. 우리는 개인정보 보호법을 준수하고 이용자의 동의를
                  얻어 개인정보를 수집합니다. 개인정보를 수집할 때 우리는 이유와
                  목적을 이용자에게 알리며 서비스를 제공하는 데 필요한 기간 동안
                  이용자의 개인정보를 보관합니다.
                  <br />
                  우리는 법에 따라 요구되는 경우를 제외하고 개인식별정보를
                  공개하거나 제3자와 공유하지 않습니다. 우리는 이용자 데이터의
                  무단 액세스, 복사, 공개, 사용 및 수정, 손실 및 도난을 방지하기
                  위해 상업적으로 허용된 수단으로써 저장된 데이터를 보호합니다.
                  이 웹사이트는 우리 소유가 아닌 외부 사이트에 링크될 수
                  있습니다. 우리는 이러한 외부 사이트의 내용 및 관행을 제어할 수
                  없음으로 각 개인정보 보호정책에 대한 책임을 지지 않습니다.
                  <br />
                  이용자는 개인정보에 대한 당사의 요청을 거절할 수 있으며 거절
                  시 일부 서비스를 이용할 수 없습니다. 이 웹사이트를 계속
                  사용하는 것은 이용자가 우리의 개인정보 및 개인정보에 대한
                  관행을 수락하는 것으로 간주합니다. 우리의 개인정보 처리방침에
                  대해 더 궁금한 점이 있는 경우 언제든지 문의해 주십시오.
                </p>
              </div>
