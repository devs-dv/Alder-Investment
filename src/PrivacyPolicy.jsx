                ...
                <ul className="list-decimal ml-6 space-y-6">
                  ...
                  <li>
                    ...
                    <ul className=" ml-6 mt-4 space-y-4">
                      {/* 2.1 */}
                      <li>
                        1) The items of other personal information collected and
                        ...
                        <ul className=" ml-6 mt-2 space-y-4">
                          <li>
                            ...
                            <ul className=" ml-6 mt-2">
                              <li>
                                <p className="underline">a. Collection Items</p>{" "}
                                - Information about the responsible officers and
                                employees of the sales and trust companies
                          ...
                          <li>
                            ...
                            <ul className=" ml-6 mt-2">
                              <li>
                                <p className="underline">a. Collection Items</p>{" "}
                                - Information about the customer's responsible
                                employees (name, company name, department,
                                position, company address, phone number, email)
                              </li>
                              <li>
                                <p className="underline">
                                  b. Purpose of Processing
                          ...
                          <li>
                            ...
                            <ul className=" ml-6 mt-2">
                              <li>
                                <p className="underline">a. Collection Items</p>{" "}
                                - Information about the responsible employees of
                                the investment trading/brokerage company or
                              ...
                              <li>
                                ...
                                information on requests from corporate investors
                              </li>
                            </ul>
                          </li>
                          {/* 2.4 */}
                          <li>
                            ...
                            access frequency and time, and service usage records
                            is automatically collected while using internet
                            homepage services or processing website user
                            information .
                            <ul className=" ml-6 mt-2">
                              <li>
                                <p className="underline">a. Collection Items</p>{" "}
                                - A cookie is a very small text file sent by the
                                server used to operate the website to the user's
                                browser, and it is stored on the computer or
                                mobile device used by the user to access the
                                website. ALDER INVESTMENTS LTD. will provide
                                enhanced online experience to website users
                                through cookies, particularly by analyzing
                                users' access frequency, visit times, visit
                                counts, and preferred technical environments, as
                                well as assessing operation of the website.
                              </li>
                              <li>
                                <p className="underline">
                                ...
                                - Installation/operation and rejection of
                                cookies:
                                <br /> Users can choose about installing
                                cookies. Accordingly, users can set options in
                                their web browser to allow all cookies, verify
                                when a cookie is stored, or refuse the storage
                                of all cookies. However, refusing the storage of
                      ...
                      <li>
                        {" "}
                        <p>
                          2) The company collects the above information by using
                          the following methods.{" "}
                        </p>
                        - Information of employees of the selling company,
                        investmenttrading/brokerage company and corporate
                        investors of the collective investment scheme is
                        specified in contracts or related documents, or provided
                        separately by the customer.{" "}
                      </li>
                      <li>
                        {" "}
                        <p>
                          3) The company must use the personal information
                          provided by the customer within the scope of the above
                          purposes. However, in the following cases, it may be
                          used beyond the scope of the purposes as an exception.
                        </p>
                        <ul className="ml-6 mt-2">
                          <li>
                  ...
                  <li>
                    ...
                    <ul className=" ml-6 mt-2">
                      <li>
                        1) Personal information printed on paper: Shred with a
                        shredder or incinerated for disposal
                      </li>
                      <li>
                        2) Personal information stored in electronic file
                        format: Permanently delete by using technical methods
                  ...
                  <li>
                    ...
                    <ul className="ml-6 mt-2">
                      <li>
                        1) The company cannot provide the personal information
                      ...
                      <li>
                        2) When the company obtains the customer's consent
                      ...
                      <li>
                        3) The company may provide information to a third party
                      ...
                      <ul className=" ml-6">
                        ...
                        <li>
                          ...
                          statistical compilation and academic research, and
                          personal information is provided in a form that does
                          not allow the identification of a specific individual.
                        </li>
                      </ul>
                    </ul>
                  </li>
                  ...
                  <li>
                    ...
                    <ul className="ml-6 mt-2">
                      <li>
                        1) Right to request inspection of personal information
                      </li>
                      <ul className=" ml-6 mt-2">
                        <li>
                        ...
                        <ul className=" ml-6 mt-2">
                          <li>
                            a. When inspection is prohibited or restricted by
                            law
                          </li>
                          <li>
                      ...
                      <li>
                        2) Right to request correction or deletion of personal
                        information
                      </li>
                      <ul className=" ml-6 mt-2">
                        <li>
                        ...
                        <li>
                          ...
                          such as correction or deletion and inform the customer
                          of the results when the customer requests correction
                          or deletion of his/her personal information, unless a
                          special procedure is prescribed by other statutes.
                        </li>
                        <li>
                          ③ When the company deletes personal information, it
                          must ensure that it cannot be recovered or reproduced.
                        </li>
                        <li>
                      ...
                      <li>
                        3) Right to Request Suspension of Personal Information
                        Processing
                      </li>
                      <ul className="ml-6 mt-2">
                        <li>
                  ...
                  <li>
                    ...
                    <ul className="ml-6">
                      <li>
                        1) Establishment and implementation of an internal
                        management plan for the secure processing of personal
                        information
                      </li>
                      <li>
                        {" "}
                        2) Measures to control access to personal information
                        and restrict access rights
                      </li>
                      <li>
                        3) Application of encryption technology or equivalent
                        measures to securely store and transmit personal
                        information
                      </li>
                      <li>
                        4) Measures to preserve access logs and prevent forgery
                        and alteration in response to personal information
                        breach incidents
                      </li>
                      <li>
                        {" "}
                        5) Installation and updating of security programs for
                        personal information
                      </li>
                      <li>
                        6) Physical measures such as preparing storage
                        facilities or installing locking devices for the safe
                    ...
                    <div className="mt-6">
                      <ul className="list-decimal ml-6 space-y-4">
                        ...
                        <li>
                          ...
                          <ul className=" ml-6 mt-2">
                            <li>
                              - Jurisdiction: Application for personal
                              information dispute mediation, collective dispute
          ...
          <div className="flex-[3]">
            <div className="ml-5">
              ...
              <ul className="list-decimal">
                ...
                <p>
                  ㈜알더인베스트먼트는 개인정보보호법 제 30 조 및
                  정보통신망이용촉진 및 정보보호에 관한 법률 제 27 조의 2 에
                  따라 정보주체(고객)의 개인정보 보호 및 권익을 보호하고
                  개인정보와 관련한 정보주체의 고충을 원활하게 처리할 수 있도록
                  하기 위하여 다음과 같은 처리방침을 두고 있습니다.
                </p>
                <p className="mt-2">
                  본 방침은 관련 법령의 제 • 개정이나 정부 또는 회사의 운용
                  방침에 따라 변경될 수 있으며 변경 시에는 회사의 인터넷
                  홈페이지를 통하여 변경 내용이 공개됩니다.
                </p>
                <li className="font-bold mt-4">
                  개인정보 수집항목, 방법 및 처리 목적
                </li>
                ※ ㈜알더인베스트먼트는 직판 또는 개인고객을 상대로 영업을
                수행하지 않는 사유로 어떠한 경우에도 개인고객의 정보를
                수집/저장하지 않습니다. 다만, 인터넷 홈페이지 서비스를
                이용하거나 회사가 홈페이지 이용자 정보를 처리하는 과정에서
                이용자의 접속 빈도와 시간, 서비스 이용 기록 등과 같은 '쿠키'
                정보가 자동으로 수집됩니다.
                <br />※ 고객참여 이벤트, 경품행사, 고객의 시장정보 정기구독 요청
                등을 웹 사이트로 진행하는 경우에는 해당 이벤트 목적으로 고객의
                기본 정보 (이름, 주소, 이메일, 전화번호 등) 가 수집/저장될 수
                있습니다. 이러한 경우에도 ㈜알더인베스트먼트의 웹사이트는 명함
                수준의 기본 정보 이외 다른 개인 정보를 일체 수집하지 않습니다.
                <br />
              ...
              같습니다. */}
                <ul className="mt-2 ml-6">
                  ...
                  <ul className=" ml-6">
                    ...
                    <li>
                      ...
                      <ul className="mt-2 ml-6">
                        <li>
                          <p className="underline">가. 수집항목</p>-
                          판매,신탁회사의 담당 임직원에 관한 정보(이름, 회사명,
                          부서,직급, 회사 주소, 전화번호, 이메일)
                        </li>
                        <li>
                          <p className="underline">나. 처리 목적</p>-
                          집합투자기구 위탁판매, 신탁 업무와 관련한 업무수행
                        </li>
                      </ul>
                    </li>
                    <li>
                      ② 투자자문계약 체결 및 이행을 위하여 불가피하게 필요한
                      경우
                      <ul className="mt-2 ml-6">
                        <li>
                          <p className="underline">가. 수집항목</p>- 고객의 담당
                          임직원에 관한 정보(이름, 회사명, 부서, 직급, 회사
                          주소, 전화번호, 이메일)
                        </li>
                        <li>
                          <p className="underline">나. 처리 목적</p>- 계약서
                          체결 및 투자자문업무 수행
                        </li>
                      </ul>
                    </li>
                    <li>
                      ...
                      <ul className="mt-2 ml-6">
                        <li>
                          <p className="underline">가. 수집항목</p>-
                          투자매매/중개회사 또는 법인투자자의 담당 임직원에 관한
                          정보(이름, 회사명, 부서, 직급, 회사 주소, 전화번호,
                          이메일)
                        </li>
                        <li>
                          <p className="underline">나. 처리 목적</p>- 주문 업무
                          수행 및 법인투자자의 요청사항에 대한 정보제공
                        </li>
                      </ul>
                    </li>
                    <li>
                      ④ 인터넷 홈페이지 서비스를 이용하거나 회사가 홈페이지
                      이용자 정보를 처리하는 과정에서 이용자의 접속 빈도와 시간,
                      서비스 이용 기록 등과 같은 ‘쿠키’ 정보가 자동으로 수집되는
                      경우
                      <ul className="mt-2 ml-6">
                        <li>
                          <p className="underline">가. 수집항목</p>-
                          쿠키('cookie')는 웹사이트를 운영하는데 이용되는 서버가
                          이용자의 브라우저에게 보내는 아주 작은 텍스트 파일로
                          이용자가 웹사이트에 접속하는데 사용하고 있는 컴퓨터나
                          모바일 기기에 저장됩니다. ㈜알더인베스트먼트에서는
                          쿠키를 통해 웹사이트 이용자에게 더 개선된 온라인
                          경험을 제공하고자 하며, 특히 웹사이트 이용자의 접속
                          빈도, 방문 시간, 방문 횟수, 선호하는 기술 환경 등을
                          분석하고 웹사이트가 잘 운영되고 있는지 분석합니다.
                        </li>
                        <li>
                          <p className="underline">
                            나. 개인정보 자동 수집 장치의 설치/운영 및 거부에
                            관한 사항
                          </p>
                          -쿠키의 설치/운영 및 거부:<br></br> 이용자는 쿠키
                          설치에 대한 선택권을 가지고 있습니다. 따라서 이용자는
                          ...
                          {/* ish ke uper sab ka text change h 
                        ishke niche nhi.... */}
                        </li>
                      </ul>
                    </li>
                  ...
                  <li>
                    <p>
                      2) 회사는 상기의 정보를 다음과 같은 방법으로 수집합니다.
                    </p>
                  ...
                  <li>
                    3) 회사는 고객이 제공한 개인정보를 상기의 목적 범위 내에서
                    ...
                    <ul className="ml-6 mt-2">
                      ...
                      <li>
                        ...
                        경우로서 특정 개인을 알아볼 수 없는 형태로 개인정보를
                        제공하는 경우
                      </li>
                    </ul>
                  </li>
                ...
                {/* 3 */}
                <li className="font-bold mt-4">개인정보의 처리 및 보유기간</li>
                ...
                <ul className="mt-2 ml-6">
                  <li>
                    1) 종이에 출력된 개인정보: 분쇄기로 분쇄하거나 소각을 통하여
                    폐기
                  </li>
                  <li>
                    2) 전자적 파일형태로 저장된 개인정보: 기록을 재생할 수 없는
                    기술적 방법을 사용하여 영구 삭제
                  </li>
                </ul>
                {/* 5 */}
                ...
                <ul className="mt-2 ml-6">
                  <li>
                    1) 회사는 고객이 제공한 개인정보를 고객의 동의 없이
                    개인정보취급 수탁자 이외의 제3자에게 제공할 수 없습니다.
                    다만, 다음의 경우에는 수집 목적 범위 내에서 제공할 수
                    있습니다.
                  </li>
                  <ul className="mt-2 ml-6">
                    <li>
                  ...
                  <li>
                    2)회사가 상기 1)에 따라 고객의 동의를 받을 때에는 다음의
                    사항을 고객에게 알려야 하며, 다음의 사항을 변경하는 경우에도
                    이를 알리고 동의를 받아야 합니다.
                  </li>
                  <ul className="mt-2 ml-6">
                    <li>① 개인정보를 제공받는 자</li>
                  ...
                  <li>
                    3) 회사는 다음의 경우에는 상기 1), 2)의 목적 범위를 초과하여
                    제3자에게 정보를 제공할 수 있습니다.
                  </li>
                  <ul className="mt-2 ml-6">
                    <li>① 고객으로부터 별도의 동의를 받는 경우</li>
                    <li>② 법률에 특별한 규정이 있는 경우 </li>
                ...
                <ul className="mt-2 ml-6">
                  ...
                  <li>2) 개인정보 정정, 삭제 요구권 </li>
                  <ul className="mt-2 ml-6">
                    <li>
                      ① 고객은 회사에게 자기 개인정보의 정정 또는 삭제를 요구할
                      수 있습니다. 다만, 다른 법령에서 그 개인정보가 수집
                      대상으로 명시되어 있는 경우에는 삭제를 요구할 수 없습니다.
                    </li>
                    <li>
                      ② 회사는 고객이 자기 개인정보의 정정 또는 삭제를 요구할
                      경우 다른 법령에 특별한 절차가 규정되어 있는 경우를
                      제외하고는 지체없이 정정, 삭제 등 필요한 조치를 취한 후 그
                      결과를 고객에게 알려야 합니다.
                    </li>
                    <li>
                      ③ 회사가 개인정보를 삭제할 때에는 복구 또는 재생되지
                      않도록 조치하여야 합니다.
                    </li>
                    <li>
                  ...
                  <ul className="mt-2 ml-6">
                    ...
                    <ul>
                      <li>
                        ...
                        위하여 불가피한 경우 나. 다른 사람의 생명, 신체를 해할
                      ...
                      <li>
                        ...
                        제공하지 못하는 등 계약의 이행이 곤란한 경우로서 고객이
                        그 계약의 해지의사를 명확하게 밝히지 아니한 경우 ③
                        회사는 고객의 요구에 따라 처리가 정지된 개인정보에
                        대하여 지체없이 해당 개인정보의 파기 등 필요한 조치를
                        하여야 합니다.
                      </li>
                    </ul>
                    <li>
                ...
                안정성 확보에 필요한 관리적, 기술적, 물리적 조치를 하고
                있습니다.
                <ul className=" mt-2 ml-6">
                  <li>
                    1) 개인정보의 안전한 처리를 위한 내부 관리 계획의 수립, 시행
                  </li>
                  <li>2) 개인정보에 대한 접근 통제 및 접근 권한의 제한 조치</li>
                  <li>
                    3) 개인정보를 안전하게 저장, 전송할 수 있는 암호화 기술의
                    적용 또는 이에 상응하는 조치
                  </li>
                  <li>
                    4) 개인정보 침해사고 발생에 대응하기 위한 접속 기록의 보관
                    및 위조, 변조 방지를 위한 조치
                  </li>
                  <li>5) 개인정보에 대한 보안프로그램의 설치 및 갱신</li>
                  <li>
                    6) 개인정보의 안전한 보관을 위한 보관시설의 마련 또는 잠금
                    장치의 설치 등 물리적 조치
                  </li>
                </ul>
                {/* 9 */}
                <li className="font-bold mt-4">개인정보에 관한 민원서비스</li>
                <p>
                ...
                <p className="mt-2">
                  고객께서는 회사의 서비스를 이용하시며 발생하는 모든
                  개인정보보호 관련 민원을 상기의 개인정보보호 관리자 또는
                  책임자에게 신고하실 수 있습니다. 회사는 지적된 문제를 즉시
                  확인하고 수정이 필요한 경우 최대한 빠른 시간 내에 조치하도록
                  하겠습니다. 회사는 항상 고객의 개인정보를 보호하기 위하여
                  최선의 노력을 다하겠습니다.
                </p>
                <p className="mt-2">개인정보에 대한 권익침해 구제 </p>
                <p className="mt-2">
                ...
                <ul className="list-decimal mt-2 ml-6">
