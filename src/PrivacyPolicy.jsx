          ...
          <div className="flex-[3]">
            ...
            <ul className="list-decimal">
              ...
              <p>
                ...
                정보통신망이용촉진 및 정보보호에 관한 법률 제 27 조의 2 에 따라
                정보주체(고객)의 개인정보 보호 및 권익을 보호하고 개인정보와
                관련한 정보주체의 고충을 원활하게 처리할 수 있도록 하기 위하여
                다음과 같은 처리방침을 두고 있습니다.
              </p>
              <p className="mt-2">
                본 방침은 관련 법령의 제 • 개정이나 정부 또는 회사의 운용 방침에
                따라 변경될 수 있으며 변경 시에는 회사의 인터넷 홈페이지를
                통하여 변경 내용이 공개됩니다.
              </p>
                ...
                <ul className=" ml-6">
                  ...
                  <li>
                    ...
                    <ul className="mt-2 ml-6">
                      ...
                      <li>
                        <p className="underline">나. 처리 목적</p>- 집합투자기구
                        위탁판매, 신탁 업무와 관련한 업무수행
                      </li>
                    </ul>
                  </li>
                  <li>
                    ...
                    <ul className="mt-2 ml-6">
                      ...
                      <li>
                        <p className="underline">나. 처리 목적</p>- 계약서 체결
                        및 투자자문업무 수행
                      </li>
                    </ul>
                  </li>
                  ...
                  <li>
                    ...
                    <ul className="mt-2 ml-6">
                      <li>
                        ...
                        쿠키를 통해 웹사이트 이용자에게 더 개선된 온라인 경험을
                        제공하고자 하며, 특히 웹사이트 이용자의 접속 빈도, 방문
                        시간, 방문 횟수, 선호하는 기술 환경 등을 분석하고
                        웹사이트가 잘 운영되고 있는지 분석합니다.
                      </li>
                      <li>
                        <p className="underline">
                          나. 개인정보 자동 수집 장치의 설치/운영 및 거부에 관한
                          사항
                        </p>
                        -쿠키의 설치/운영 및 거부:<br></br> 이용자는 쿠키 설치에
                        대한 선택권을 가지고 있습니다. 따라서 이용자는
                        웹브라우저에서 다음과 같이 옵션을 설정함으로써 모든
                        쿠키를 허용하거나, 쿠키가 저장될 때마다 확인을 거치거나,
                        아니면 모든 쿠키의 저장을 거부할 수도 있습니다. 다만,
                        쿠키의 저장을 거부할 때, 일부 맞춤형 서비스를 받는데
                        제한을 받을 수 있습니다.
              ...
              <ul className="mt-2 ml-6">
                <li>
                  ...
                  개인정보취급 수탁자 이외의 제3자에게 제공할 수 없습니다. 다만,
                  다음의 경우에는 수집 목적 범위 내에서 제공할 수 있습니다.
                </li>
                <ul className="mt-2 ml-6">
                  <li>
              ...
              <ul className="mt-2 ml-6">
                ...
                <ul className="mt-2 ml-6">
                  ...
                  <li>
                    ...
                    열람할 수 없는 정당한 사유가 있을 때에는 고객에게 그 사유를
                    알리고 열람을 연기할 수 있으며, 그 사유가 소멸하면 지체없이
                    열람하게 하여야 합니다.
                  </li>
                  <li>
                ...
                <ul className="mt-2 ml-6">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      계약의 해지의사를 명확하게 밝히지 아니한 경우 ③ 회사는
                      고객의 요구에 따라 처리가 정지된 개인정보에 대하여
              ...
              <ul className=" mt-2 ml-6">
                ...
                <li>
                  3) 개인정보를 안전하게 저장, 전송할 수 있는 암호화 기술의 적용
                  또는 이에 상응하는 조치
                </li>
                <li>
                  4) 개인정보 침해사고 발생에 대응하기 위한 접속 기록의 보관 및
                  위조, 변조 방지를 위한 조치
                </li>
              ...
              <ul className="list-decimal mt-2 ml-6">
                ...
                <li>대검찰청 사이버범죄수사단: 02-3480-3581 (www.spo.go.kr)</li>
                <li>
