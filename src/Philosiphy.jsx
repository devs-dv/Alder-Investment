      ...
      {language ? (
        <div className="flex flex-col lg:flex-row lg:items-start lg:gap-10">
          ...
          <div className="lg:w-[50%] ml-auto lg:-mr-4 lg:mt-1">
            ...
            <div>
              <p className="mt-1 text-[#545454] font-light flex-[3] text-sm md:text-xl lg:text-base opacity-90">
                Growth is only sustainable when it's informed. We take a close
                look at each client's portfolio to identify where risk is hiding
                beneath the surface. We believe that only when we properly
                understand risk today.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row lg:gap-10">
          ...
          {/* Video Section */}
          <div className="lg:w-[50%] ml-auto lg:-mr-4 lg:mt-1">
            <div className="lg:max-h-[750px] md:h-[725px] h-[400px] overflow-hidden">
              <video
                className="w-full h-full  object-cover"
                autoPlay
                loop
            ...
            <div>
              <p
                className="mt-1 text-[#545454] font-light flex-[3] text-sm md:text-xl lg:text-base opacity-90"
                style={{ wordBreak: "keep-all" }}
              >
