...
const Heading = () => (
  <>
    <h1 className="font-medium text-white text-4xl md:text-6xl lg:text-[5rem] lg:container max-md:mb-20 max-lg:-mt-36 absolute top-1/3 left-[6vw] max-md:left-[5.5vw] max-md:top-[45vh] nest-hub:text-5xl nest-hub-max:text-6xl">
