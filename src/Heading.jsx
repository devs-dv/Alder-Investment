...
const Heading = () => (
  <>
    <h1 className="font-medium text-white text-4xl md:text-6xl lg:text-[5rem] lg:container mb-20 md:mb-0 max-lg:-mt-36 absolute md:top-1/3 top-[29vh] md:left-[6vw] left-[5.5vw] nest-hub:text-5xl nest-hub-max:text-6xl">
