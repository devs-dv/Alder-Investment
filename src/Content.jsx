          ...
          >
            {language ? (
              <>
                ...
                office specializing in customised private wealth management and
                related services for a select clientele of the most
                distinguished ultra-high net worth individuals, their families,
                and their businesses. Our globally informed perspective means we
                can see possibilities anywhere. With an independent approach, we
                cast our vision into the future to help our clients unlock
                sustainable, long-term growth that can be passed down for
                generations to come.
              </>
            ) : (
              <>
                ALDER INVESTMENTS는 글로벌 전문성과 외부 이해관계에 얽매이지
                않은 독립적 통찰력을 기반으로 최상위 수준의 맞춤형 자산 관리
                솔루션을 제공하는 전문 부티크 패밀리 오피스입니다.
                <br />
