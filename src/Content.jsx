...
const Content = ({ language }) => {
  ...
  return (
    <div className="absolute max-h-[600px]:relative max-h-[600px]:mt-[250px] bottom-10 md:bottom-4 right-0 left-0 md:left-auto md:right-[-18px] lg:mr-10 text-justify p-2 md:p-12 lg:p-4 text-[#898981] z-20 md:max-w-3xl lg:max-w-4xl min-h-[150px]">
